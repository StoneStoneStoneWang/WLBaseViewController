...
extension UITabBarController {
    ...
    @objc (addChildWithChild:andTitle:andFontSize:andTitleColor:andHighColor:andImgName:andSelectedImgName:)
    public func addChildVC(childVC: UIViewController, title: String = "" ,fontSize: CGFloat,titleColor: UIColor ,highColor: UIColor,imageName: String = "" ,selectedImageName: String = "" ) {
